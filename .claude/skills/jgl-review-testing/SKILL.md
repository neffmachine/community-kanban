...
description: Audit the test suite for substantive quality using LLM analysis, static analysis, and coverage data. Produces a plan to improve testing if warranted. Use when the user says "review tests", "/jgl-review-testing", "audit tests", "how are my tests?", "improve test quality", or before a refactor.
---
