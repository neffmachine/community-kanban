---
name: jgl-status
description: Session checkpoint — what changed, what's still open, anything risky uncommitted. Use when the user says "status", "/jgl-status", "where are we", or before /jgl-commit on a long session.
---
