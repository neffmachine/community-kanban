---
name: jgl-commit
description: Stage and commit changes locally with a meaningful message. Does NOT push. Use when the user says "commit", "/jgl-commit", "save my work", or "checkpoint".
---
